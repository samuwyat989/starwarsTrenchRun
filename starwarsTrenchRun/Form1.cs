...
namespace starwarsTrenchRun
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            SolidBrush brush2 = new SolidBrush(Color.DarkSalmon);
            Font title2 = new Font("Times New Roman", 20, FontStyle.Bold);
            g.DrawString("TOP SECRET", title2, brush2, 100, 100);
            ...
            {              
                ...
                for (int i = 0; i <= 304; i++)
                {
                    ...
                    if (i >= 0 && i <= 60)
                    {
                        ...
                        g.DrawLine(pen, 325, 153, 325, 275);
                        g.DrawLine(pen, 335, 153, 335, 275);
                        g.DrawPolygon(pen, port);
